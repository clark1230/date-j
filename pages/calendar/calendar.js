...
var refreshPageData = function (year, month, day) {
  ...
  if (day!= new Date().getDay()) {
    ...
    setCurDetailIndex(new Date().getDay());
  }
  console.log(year, month, day, offset);
};
...
Page({
  ...
  goLastMonth: function (e) {
    ...
    if (curMonth == new Date().getMonth() && curYear == new Date().getFullYear()) {
      refreshPageData(curYear, curMonth, new Date().getDay());
